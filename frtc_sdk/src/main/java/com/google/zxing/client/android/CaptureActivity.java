...
//    private TextView statusView;
    ...
    private ImageButton btnScanFlash;
...
//    historyManager.trimHistory();
        ...
        viewfinderView = (ViewfinderView) findViewById(R.id.finder);
...
//        statusView = (TextView) findViewById(R.id.status_view);
        ...
        ImageButton btnPhoto = (ImageButton) findViewById(R.id.album_btn);
        ...
        flashStatus = false;
        btnScanFlash = (ImageButton) findViewById(R.id.flash_btn);
        btnScanFlash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                switchFlash();
            }
...
//    }
        ...
        SurfaceView surfaceView = (SurfaceView) findViewById(R.id.show_area);
...
//        if (null != popupWindow) {
//            btnScanFlash.setVisibility(View.VISIBLE);
//            popupWindow.dismiss();
//        }
        if (null == result) {
            Log.i(TAG, "Wrong photo format");
            BaseToast.showToast(getApplicationContext(), getString(R.string.msg_qrscan_result_error), Toast.LENGTH_SHORT);
        } else {
            //Log.d("CaptureActivity", "result is " + result);
...
//            Log.w(TAG, "Unexpected error initializing camera", e);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setMessage(getString(R.string.msg_camera_error));
        builder.setPositiveButton(R.string.btn_confirm_ok, new FinishListener(this));
...
//        Log.i(TAG, "switchFlash from " + flashStatus + " to " + !flashStatus);
        if (flashStatus) {
            btnScanFlash.setImageResource(R.drawable.icon_light_gray);
            cameraManager.setTorch(false);
        } else {
            btnScanFlash.setImageResource(R.drawable.icon_light_on);
            cameraManager.setTorch(true);
        }
        ...
        switch (requestCode) {
            case STORAGE_PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    String tipFormat = getResources().getString(R.string.msg_open_photo_grant_permission);
                    String tip = String.format(tipFormat, getResources().getString(R.string.app_name));
                    BaseToast.showToast(this, tip, Toast.LENGTH_SHORT);
                }
                break;
            default:
        }
...
//            Log.i(TAG, "onActivityResult: user has select photo.");
            String photoPath = RealPathFromUriUtils.getRealPathFromUri(this, data.getData());
            if (photoPath == null) {
//                Log.i(TAG,"photo path is null");
                BaseToast.showToast(getApplicationContext(), getString(R.string.msg_qrscan_result_error), Toast.LENGTH_SHORT);
            } else {
    ...
    /**
     * start thread to parse photo
     *
     * @param path
     */
//    private PopupWindow popupWindow;
    private void parsePhoto(String path) {
//        Log.i(TAG, "parsePhoto");
        //show loading
//        popupWindow = new PopupWindow();
//        popupWindow.setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
//        popupWindow.setWidth(ViewGroup.LayoutParams.WRAP_CONTENT);
//        popupWindow.setFocusable(true);
//        View view = LayoutInflater.from(this).inflate(R.layout.loading_window,null);
//        popupWindow.setContentView(view);
//        popupWindow.showAtLocation(getWindow().getDecorView(), Gravity.CENTER,0,0);
//        btnScanFlash.setVisibility(View.GONE);
