...
public class InformDlg extends BaseDialog {

    private final String TAG = InformDlg.class.getSimpleName();
    ...
    public InformDlg(Context context, String titleStr, String contentStr, String okStr) {
